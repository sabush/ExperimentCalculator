  ...
  tagList(
    fluidPage(
      column(
        ...
        shinyWidgets::numericInputIcon(ns('prop_base'), 'Success rate in the baseline group', 20,
                         icon = list(NULL, icon("percent"))),
        shinyBS::bsTooltip(ns('prop_base'),
        ...
        conditionalPanel(condition = "input.calc_type == 'mss' & input.effect_type == 'abs'",
                         shinyWidgets::numericInputIcon(ns('min_effect_abs'), 'Minimum Detectible Effect', 5,
                                          icon = list(NULL, icon("percent"))),
                         ns = ns,
