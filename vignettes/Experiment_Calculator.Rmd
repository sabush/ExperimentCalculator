...
![Power calculation dialogue for Binary outcomes](power_bin.png){width=100%}
...
![Power calculation dialogue for Numeric outcomes](power_norm.png){width=100%}
...
![Significance calculation dialogue for Binary outcomes](sig_bin.png){width=100%}
...
![Significance calculation dialogue for Numeric outcomes](sig_norm.png){width=100%}
...
![Sample Ratio Test dialogue](srm.png){width=100%}
